...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './auction.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AUCTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_AUCTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AUCTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AUCTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AUCTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AUCTION actions', async () => {
      const expectedActions = [
        {
